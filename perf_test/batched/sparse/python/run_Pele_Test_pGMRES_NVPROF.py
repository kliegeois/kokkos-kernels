...
def main():
    ...
    for i in range(0, len(Ns)):
        ...
        testfile = data_d+'/nvprof.'+str(implementation)+'.'+str(n)+'.'+str(nnzs[i])+'.'+str(Ns[i])+'.'+str(team_size)+'.'+str(rows_per_thread)

        nvprof_exe = '/home/projects/ppc64le-pwr9-nvidia/cuda/10.2.2/bin/nvprof'
        run_test_nvprof(nvprof_exe, directory+'/KokkosBatched_Test_GMRES', testfile, name_A, name_B, name_X, rows_per_thread, team_size, n1=n1, n2=n2, implementation=implementation, layout='Left', extra_args=' -P')
        run_test_nvprof(nvprof_exe, directory+'/KokkosBatched_Test_GMRES', testfile, name_A, name_B, name_X, rows_per_thread, team_size, n1=n1, n2=n2, implementation=implementation, layout='Right', extra_args=' -P')
