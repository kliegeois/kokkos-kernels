...
struct TeamVectorGemv<MemberType, Trans::NoTranspose, Algo::Gemv::Unblocked> {
  ...
  KOKKOS_INLINE_FUNCTION static int invoke(
    ...
    if (AViewType::Rank == 2)
      ...
      return TeamVectorGemvInternal<Algo::Gemv::Unblocked>::template invoke<MemberType, ScalarType,
        typename AViewType::array_layout,
        typename AViewType::non_const_value_type>(
          member, A.extent(0), A.extent(1), A.extent(2), alpha, A.data(), A.stride_0(),
          A.stride_1(), A.stride_2(), x.data(), x.stride_0(), x.stride_1(), beta, y.data(), y.stride_0(), y.stride_1());
  }
};
  ...
  KOKKOS_INLINE_FUNCTION static int invoke(
    ...
    if (AViewType::Rank == 2)
      ...
      return TeamVectorGemvInternal<Algo::Gemv::Unblocked>::template invoke<MemberType, ScalarType,
        typename AViewType::array_layout,
        typename AViewType::non_const_value_type>(
          member, A.extent(0), A.extent(2), A.extent(1), alpha, A.data(), A.stride_0(),
          A.stride_2(), A.stride_1(), x.data(), x.stride_0(), x.stride_1(), beta, y.data(), y.stride_0(), y.stride_1());
  }
};
