...
KOKKOS_INLINE_FUNCTION int SerialCopy<Trans::NoTranspose, 2>::invoke(
  ...
  #endif
  if (A.extent(0) == 1) {
    return SerialCopy<Trans::NoTranspose, 1>::invoke(Kokkos::subview( A, 0, Kokkos::ALL), Kokkos::subview( B, 0, Kokkos::ALL));
  }
...
KOKKOS_INLINE_FUNCTION int SerialCopy<Trans::Transpose, 2>::invoke(
  ...
  #endif
  if (A.extent(1) == 1) {
    return SerialCopy<Trans::Transpose, 1>::invoke(Kokkos::subview( A, Kokkos::ALL, 0), Kokkos::subview( B, Kokkos::ALL, 0));
  }
...
struct TeamCopy<MemberType, Trans::NoTranspose, 2> {
  ...
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member,
    ...
    #endif
    if (A.extent(0) == 1) {
      return TeamCopy<MemberType, Trans::NoTranspose, 1>::invoke(member, Kokkos::subview( A, 0, Kokkos::ALL), Kokkos::subview( B, 0, Kokkos::ALL));
    }
...
struct TeamCopy<MemberType, Trans::Transpose, 2> {
  ...
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member,
    ...
    #endif
    if (A.extent(1) == 1) {
      return TeamCopy<MemberType, Trans::Transpose, 1>::invoke(member, Kokkos::subview( A, Kokkos::ALL, 0), Kokkos::subview( B, Kokkos::ALL, 0));
    }
...
struct TeamVectorCopy<MemberType, Trans::NoTranspose, 2> {
  ...
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member,
    ...
    #endif
    if (A.extent(0) == 1) {
      return TeamVectorCopy<MemberType, Trans::NoTranspose, 1>::invoke(member, Kokkos::subview( A, 0, Kokkos::ALL), Kokkos::subview( B, 0, Kokkos::ALL));
    }
...
struct TeamVectorCopy<MemberType, Trans::Transpose, 2> {
  ...
  KOKKOS_INLINE_FUNCTION static int invoke(const MemberType &member,
    ...
    #endif
    if (A.extent(1) == 1) {
      return TeamVectorCopy<MemberType, Trans::NoTranspose, 1>::invoke(member, Kokkos::subview( A, Kokkos::ALL, 0), Kokkos::subview( B, Kokkos::ALL, 0));
    }
